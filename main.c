...
void main(void)
{
  ...
  if((TISM_RegisterTask(&Sounds,"Sounds",PRIORITY_NORMAL)+
      TISM_RegisterTask(&Control,"Control",PRIORITY_HIGH)+
      TISM_RegisterTask(&Lights,"Lights",PRIORITY_HIGH)+
      TISM_RegisterTask(&Scenes,"Scenes",PRIORITY_LOW))!=0)
  {
  ...
  System.Task[TISM_GetTaskID("TISM_IRQHandler")].TaskDebug=DEBUG_LOW;
  //System.Task[TISM_GetTaskID("Scenes")].TaskDebug=DEBUG_LOW;
  //System.Task[TISM_GetTaskID("Scenes")].TaskDebug=DEBUG_LOW;
